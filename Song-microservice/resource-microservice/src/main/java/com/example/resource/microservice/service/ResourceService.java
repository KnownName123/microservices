package com.example.resource.microservice.service;

import com.example.resource.microservice.dto.SongMetadataDto;
import com.example.resource.microservice.exception.BadRequestException;
import com.example.resource.microservice.exception.ResourceNotFoundException;
import com.example.resource.microservice.model.Resource;
import com.example.resource.microservice.repository.ResourceRepository;
...
public class ResourceService {
    ...
    public List<Long> delete(String csv) {
        if (csv == null || csv.isBlank() || csv.length() > 200) {
            throw new BadRequestException("Invalid CSV string");
        }
